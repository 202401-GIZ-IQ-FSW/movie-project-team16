    ...
    useEffect(() => {
        let ctx = gsap.context(() => {
            ...
            .to(top_h1.current,{
             ...
             .to(bottom_h1.current,{
                bottom: "-30%"
             },'a')
            .to(center_h1.current,{
               top: "-30%"
            },'a')
            .to(content.current,{
               delay: -0.2,
    ...
    <div>
        ...
        <div ref={center} id="hero_center">
            <div ref={content} className="hero_content">
                <h4>Notflix</h4>
                <h3><i>Explore </i> a cinematic journey through the <i>digital aisles</i> of movie treasures.</h3>
        ...
        <div ref={bottom} id="hero_bottom" >
            <h1 ref={bottom_h1} id="hero_bottom-h1">Notflix</h1>
        </div>
    </div>
